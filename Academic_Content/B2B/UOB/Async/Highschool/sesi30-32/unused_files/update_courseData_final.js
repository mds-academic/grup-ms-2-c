        ...
        questions: [
          {
            ...
            html: `
              <div style="text-align: left; font-family: 'Outfit', sans-serif;">
                ...
                <p style="font-size: 18px; margin-bottom: 15px;">Program tiba-tiba berhenti karena pengguna memasukkan teks huruf saat program meminta angka nominal. Jenis error apakah ini?</p>
              </div>
            `,
            choices: ["ValueError", "TypeError", "ZeroDivisionError"],
            correct: "ValueError",
            explanation: "ValueError terjadi saat tipe datanya benar, tapi isinya tidak sesuai yang diharapkan (teks yang tak bisa dijadikan angka)."
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            html: `
              <div style="text-align: left; font-family: 'Outfit', sans-serif;">
                ...
                <p style="font-size: 18px; font-weight: bold;">Di function mana letak sumber masalah (bug) yang harus kamu perbaiki?</p>
              </div>
            `,
            choices: ["get_total", "get_discount", "get_final_price"],
            correct: "get_discount",
        ...
        questions: [
          {
            ...
            html: `
              <div style="text-align: left; font-family: 'Outfit', sans-serif;">
                ...
                <p style="font-weight: 800; font-size: 18px; color: #1a1a1a; margin-bottom: 16px;">Ternyata programmer salah menulis nilai diskon 10% menjadi <code style="background-color: #E0E0E0; padding: 3px 6px; border-radius: 4px;">10</code>, padahal dalam program yang menggunakan desimal, itu membuat perhitungannya error!</p>
                <p style="font-size: 18px;">Angka desimal apa yang harus ditulis untuk mewakili diskon 10%?</p>
              </div>
            `,
            choices: ["0.1", "10", "10%"],
            correct: "0.1",
...
<span style="color: #8be9fd;">print</span><span style="color: #f8f8f2;">(transaction[</span><span style="color: #f1fa8c;">"amount"</span><span style="color: #f8f8f2;">])</span>
                ...
                <p style="font-weight: 800; font-size: 18px; color: #1a1a1a; margin-bottom: 16px;">Berapa nilai output yang dicetak?</p>
              </div>
            `,
            choices: ["\"Beli snack\"", "\"pengeluaran\"", "10000"],
            correct: "10000",
        ...
        questions: [
          {
            ...
            html: `
              <div style="text-align: left; font-family: 'Outfit', sans-serif;">
                ...
                <p style="font-weight: 800; font-size: 18px; color: #1a1a1a; margin-bottom: 16px;">Berapa Total, Terbesar, dan Terkecil secara berurutan?</p>
              </div>
            `,
            choices: ["80.000, 25.000, 10.000", "75.000, 30.000, 15.000", "85.000, 20.000, 10.000"],
            correct: "80.000, 25.000, 10.000",
            explanation: "Tepat sekali! Total = 80.000, Terbesar = 25.000, dan Terkecil = 10.000."
          }
        ]
      },
      {
